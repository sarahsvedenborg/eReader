export const aroomwithaviewChapters = [
    {
        title: "Introduction",
        text: `PART ONE`,
    },
  ...
  She joined her cousin.`,
    },
    {
        ...
        text: `It so happened that Lucy, who found daily life rather chaotic, entered a more solid world when she opened the piano. She was then no longer either deferential or patronizing; no longer either a rebel or a slave. The kingdom of music is not the kingdom of this world; it will accept those whom breeding and intellect and culture have alike rejected. The commonplace person begins to play, and shoots into the empyrean without effort, whilst we look up, marvelling how he has escaped us, and thinking how we could worship him and love him, would he but translate his visions into human words, and his experiences into human actions. Perhaps he cannot; certainly he does not, or does so very seldom. Lucy had done so never.
  ...
  They passed together through the gaunt beauty of the square, laughing over the unpractical suggestion.`,
    ...
    {
        title: "Chapter VI",
        text: `The Reverend Arthur Beebe, the Reverend Cuthbert Eager, Mr. Emerson, Mr. George Emerson, Miss Eleanor Lavish, Miss Charlotte Bartlett, and Miss Lucy Honeychurch Drive Out in Carriages to See a View; Italians Drive Them.
  ...
  So it was that after the gropings and the misgivings of the afternoon they pulled themselves together and settled down to a very pleasant tea-party. If they were hypocrites they did not know it, and their hypocrisy had every chance of setting and of becoming true. Anne, putting down each plate as if it were a wedding present, stimulated them greatly. They could not lag behind that smile of hers which she gave them ere she kicked the drawing-room door. Mr. Beebe chirruped. Freddy was at his wittiest, referring to Cecil as the “Fiasco”—family honoured pun on fiance. Mrs. Honeychurch, amusing and portly, promised well as a mother-in-law. As for Lucy and Cecil, for whom the temple had been built, they also joined in the merry ritual, but waited, as earnest worshippers should, for the disclosure of some holier shrine of joy.`,
    },
    {
        ...
        text: `A few days after the engagement was announced Mrs. Honeychurch made Lucy and her Fiasco come to a little garden-party in the neighbourhood, for naturally she wanted to show people that her daughter was marrying a presentable man.
  ...
  Cecil frowned again. Oh, these Honeychurches! Eggs, boilers, hydrangeas, maids—of such were their lives compact. “May me and Lucy get down from our chairs?” he asked, with scarcely veiled insolence. “We don’t want no dessert.”`,
    },
    {
        ...
        text: `Of course Miss Bartlett accepted. And, equally of course, she felt sure that she would prove a nuisance, and begged to be given an inferior spare room—something with no view, anything. Her love to Lucy. And, equally of course, George Emerson could come to tennis on the Sunday week.
  ...
  As if no more was possible, he slipped back; Cecil rejoined her; they reached the upper lawn alone.`,
    },
    {
        ...
        text: `But Lucy had developed since the spring. That is to say, she was now better able to stifle the emotions of which the conventions and the world disapprove. Though the danger was greater, she was not shaken by deep sobs. She said to Cecil, “I am not coming in to tea—tell mother—I must write some letters,” and went up to her room. Then she prepared for action. Love felt and returned, love which our bodies exact and our hearts have transfigured, love which is the most real thing that we shall ever meet, reappeared now as the world’s enemy, and she must stifle it.
  ...
  The scales fell from Lucy’s eyes. How had she stood Cecil for a moment? He was absolutely intolerable, and the same evening she broke off her engagement.`,
    },
    {
        ...
        text: `He was bewildered. He had nothing to say. He was not even angry, but stood, with a glass of whiskey between his hands, trying to think what had led her to such a conclusion.
  ...
  *** END OF THE PROJECT GUTENBERG EBOOK 2641 ***`,
    }
];